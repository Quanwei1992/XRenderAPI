...
def make_native_lib(abi):
    ...
    build_cmd = "cmake -G \"{0}\" -DCMAKE_SYSTEM_NAME=Android -DCMAKE_SYSTEM_VERSION={1} -DCMAKE_ANDROID_ARCH_ABI={2} -DCMAKE_ANDROID_NDK=\"{3}\" -DCMAKE_ANDROID_STL_TYPE={4} -DCMAKE_MAKE_PROGRAM=\"{5}\" ../../../../".format(build_g,ANDROID_SYSTEM_VERSION,build_arch_abi, \
